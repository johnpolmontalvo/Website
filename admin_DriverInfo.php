...
<head>
    ...
    <script src="javascript/admin_DriverInfo.js"></script>
    <link rel="stylesheet" href="css/admin_DriverInfo.css">
...
<body>
    ...
    <div class="information">
        <h1 class="driversInfo">Drivers Information</h1>
        <input type="text" id="searchInput" placeholder="First Name" />
